...
return [
    ...
    'controller_name_hint'   => 'مثال: PagesController. در صورت خالی بودن از کنترلر پیشفرض BREAD استفاده خواهد شد',
    ...
    'edit_rows'              => 'ویرایش ردیف‌های جدول :table',
    ...
    'order_ident_column'     => 'ستون نمایش برای مرتب سازی',
    'order_direction'        => 'نوع مرتب سازی',
    'order_ident_column_ph'  => 'ستونی که در صفحه مرتب سازی نشان داده می‌شود',
    'default_search_key'     => 'ستون پیشفرض برای جستجو سمت سرور',
    'default_search_key_ph'  => 'ستونی که در جستجوی سمت سرور به طور پیشفرض اتنخاب خواهد شد',
    ...
    'scope'                  => 'حوزه نمایش (scope)',
    'updated_order'          => 'چینش با موفقیت بروزرسانی شد',
    'url_slug'               => 'نامک برای آدرس ( باید یکتـا باشد )',
