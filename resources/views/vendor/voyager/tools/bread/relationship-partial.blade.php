...
<div class="row row-dd row-dd-relationship">
    ...
    <div class="col-md-12 voyager-relationship-details">
        ...
        <div class="relationship_details_content">
            ...
            <span><input type="text" class="form-control" name="relationship_model_{{ $relationship['field'] }}" placeholder="{{ __('voyager::database.relationship.namespace') }}"
                         title="{{ __('voyager::database.relationship.namespace') }} value="{{ $relationshipDetails->model ?? '' }}"></span>
        </div>
