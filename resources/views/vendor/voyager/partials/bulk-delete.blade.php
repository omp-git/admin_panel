        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    <i class="voyager-trash"></i> {{ __('voyager::generic.are_you_sure_delete1')
                    }} <span id="bulk_delete_count"></span> <span id="bulk_delete_display_name"></span> {{ __('voyager::generic.are_you_sure_delete2') }}
                </h4>
            </div>
